...
struct ExperimentalCocktails: View {
    var body: some View {
		...
		NewCocktail(title: "Tom Collins", imgName: "", rating: 6, ingredients: ["2 oz Gin", "3/4 oz Lemon Luice", "3/4 oz Simple Syrup", "~2 oz Soda Water"], notes: ["Shaken", "Highball glass", "Ice", "Add soda water", "Lemon twist; cherry"])
		...
		NewCocktail(title: "Spicy Mule", imgName: "", rating: 6, ingredients: ["2 oz Spiced Rum", "2/3 oz Lime juice", "2/3 oz Simple Syrup", "4 oz Ginger beer"], notes: ["Shaken", "Highball glass", "Ice", "Lime wheel"])
		...
		NewCocktail(title: "Vesper (James Bond)", imgName: "Vesper", rating: 6, ingredients: ["2 oz Gin", "1 oz Vodka", "1/2 oz Lillet blanc"], notes: ["Stirred", "Served up chilled", "No ice", "Lemon Twist "])
		...
		NewCocktail(title: "Presbyterian", imgName: "Presbyterian", rating: 6, ingredients: ["2 oz Whiskey", "2-3 oz Ginger Beer", "2-3 oz Soda water"], notes: ["Built in highball glass", "Ice", "Lemon peel"])
		*/
    }
}
